...
echo "[new_harness] if you also want '$name' in council.sh's rotation, fill in harness_council_run too"
echo "[new_harness] and add '$name' to LOOP_KIT_COUNCIL_HARNESSES"
